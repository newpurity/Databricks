...
-- MAGIC folder_name = "dev/sales/gold/Purina/tb_mx_sales_purina_current_week_moderno/_delta_log/__tmp_path_dir"
-- MAGIC
-- MAGIC try:
...
-- MAGIC # Definir el nombre del contenedor y la carpeta que deseas borrar
-- MAGIC container_name = "datascience"
-- MAGIC folder_name = "dev/sales/gold/Purina/tb_mx_sales_purina_current_week_moderno/_delta_log/"
-- MAGIC
-- MAGIC # Obtener una referencia al contenedor y a los blobs en la carpeta
-- MAGIC container_client = blob_service_client.get_container_client(container_name)
-- MAGIC blobs = container_client.list_blobs(name_starts_with=folder_name)
...
-- MAGIC # Definir el nombre del contenedor y la carpeta que deseas borrar
-- MAGIC container_name = "datascience"
-- MAGIC folder_name = "dev/sales/gold/Purina/tb_mx_sales_purina_current_week_moderno/"
-- MAGIC
-- MAGIC # Obtener una referencia al contenedor y a los blobs en la carpeta
-- MAGIC container_client = blob_service_client.get_container_client(container_name)
-- MAGIC blobs = container_client.list_blobs(name_starts_with=folder_name)
...
DROP TABLE sales_gold.CV_MX_SO_Purina_Current_Week_Moderno;

-- COMMAND ----------

CREATE TABLE IF NOT EXISTS  sales_gold.CV_MX_SO_Purina_Current_Week_Moderno(
CHAINSTORE string,
CODESTORE string,
...
USING delta
location '/mnt/datascience/dev/sales/gold/Purina/tb_mx_sales_purina_current_week_moderno'
comment 'Purina Sell out current week';
...
INSERT INTO sales_gold.CV_MX_SO_Purina_Current_Week_Moderno
SELECT 
    CHAINSTORE,
    CODESTORE,
    MES_NESTLE_NUM,
...
select * from delta.`/mnt/datascience/dev/sales/gold/Purina/tb_mx_sales_purina_current_week_moderno`
